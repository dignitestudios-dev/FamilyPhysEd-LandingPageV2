...
const SESSIONS_DATA = [
  {
    ...
    tag: "Families",
    title: "Family Play Sessions",
    body: "Your household versus the games you grew up on. A coach brings the equipment, the rules and the energy — you bring the family.",
    cta: "Book a session",
    href: "#contact",
    span: "lg:col-span-7",
    height: "h-72 sm:h-96",
